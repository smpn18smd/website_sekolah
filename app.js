...
function setAdminTab(tab){
  document.getElementById('admin-title').textContent={dashboard:'Dashboard',prestasi:'Kelola Prestasi',ekstrakurikuler:'Kelola Ekstrakurikuler',berita:'Kelola Berita',hero:'Hero Beranda',guru:'Kelola Guru',statistik:'Statistik'}[tab]||'Dashboard';
