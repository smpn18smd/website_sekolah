...
function setAdminTab(tab){
  document.getElementById('admin-title').textContent={dashboard:'Dashboard',berita:'Kelola Berita',ekstrakurikuler:'Kelola Ekstrakurikuler',hero:'Hero Beranda',guru:'Kelola Guru',statistik:'Statistik'}[tab]||'Dashboard';
